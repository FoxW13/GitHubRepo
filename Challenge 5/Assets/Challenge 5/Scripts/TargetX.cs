...
/*
         ...
         * Challenge 5
		 * Assignment 8
		 * This code conatins the spawning locations of the targets, the time on screen, the destruction when clicked
		 * the removal of the objects, and the explosion particle effect.
		 */
